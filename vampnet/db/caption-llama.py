...
def load_client():
    if not hasattr(load_client, "_client"):
        ...
        load_client._client = gradio_client.Client("huggingface-projects/llama-2-7b-chat")
